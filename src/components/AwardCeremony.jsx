...
const centerContainer = { position: "relative", width: "100%", minHeight: 260, display: "flex", justifyContent: "center", alignItems: "center", marginTop: `calc(${SAFE_TOP}px + 160px}`, transition: "all 0.4s ease" };
